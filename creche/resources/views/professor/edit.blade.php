    ...
    <div class="row">
        <div class="col col-6">
            ...
            <div class="col col-6">
                ...
                <input type="text" class="form-control" name='matriculaPessoa' id="matriculaPessoa" value="{{$pessoa->matricula}}">
                </div>
                <div class="col col-2">
                    <label for="Idade" class="form-label">Idade</label>
                    <input type="number" class="form-control" name="idadePessoa" id="idadePessoa" value="{{$pessoa->idade}}">
                </div>
                <div class="col col-4">
                    ...
                    <div class="col col-12">
                        ...
                        <input type="text" class="form-control" name='enderecoPessoa' id="enderecoPessoa"value="{{$pessoa->endereco}}" >
                        </div>

                        <div class="col col-12">
                            <label for="Salario" class="form-label">Salario</label>
                            <input type="text" class="form-control" name='salarioPessoa' id="salarioPessoa"value="{{$pessoa->salario}}" >
                            </div>
